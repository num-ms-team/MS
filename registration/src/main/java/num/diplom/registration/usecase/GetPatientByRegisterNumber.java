...
public class GetPatientByRegisterNumber extends PatientUseCase<String, PatientDto> {

    public GetPatientByRegisterNumber(
    ...
    public PatientDto execute(String input) throws UseCaseException {
        ...
        try {
            Patient patient = patientService.findByRegisterNumber(input);
